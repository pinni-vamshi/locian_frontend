...
class SemanticSnappingService {
    ...
    private let categoryDefinitions: [String: [String]] = [
        ...
        "general_store": ["car wash", "show room", "foam wash", "kirana", "provisions", "general store", "grocery", "mart", "shop", "store", "hardware", "electrician", "mechanic", "technician", "decor", "interior", "timber", "depot", "aluminium", "materials", "furniture", "plywood", "electrical", "paint", "complex", "malls", "ladies tailors", "fancy", "mobile point", "service center" , "service"],
        ...
        "hospital": ["hospital", "medical", "emergency", "health center", "diagnostics"],
        ...
        "shopping_mall": ["mall", "plaza", "center", "complex", "retail hub" ,"shopping", "dress", "shirt"," shorts"],
