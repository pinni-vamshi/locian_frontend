...
struct PatternModeSelector: View {
    ...
    var body: some View {
        ...
        // ✅ FIX: Respect pre-set mode if it exists to prevent "Mode Flipping" during mastery updates.
        ...
        Group {
            ...
            case .sentenceBuilder: 
                PatternBuilderLogic.view(for: drill, mode: mode, engine: engine, practiceLogic: practiceLogic, ghostLogic: ghostLogic, onComplete: onComplete)
            case .typing: 
            ...
            case .mastered:
                Color.clear.onAppear { onComplete?(true) }
            default: 
                PatternMCQLogic.view(for: drill, mode: mode, engine: engine, practiceLogic: practiceLogic, ghostLogic: ghostLogic, onComplete: onComplete)
            }
        }
