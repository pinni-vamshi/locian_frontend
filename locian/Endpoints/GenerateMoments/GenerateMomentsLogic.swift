//
//  GenerateMomentsLogic.swift
//  locian
//
//  Logic layer for Generate Moments Endpoint
//  Parses raw response data
//

import Foundation

class GenerateMomentsLogic {
    static let shared = GenerateMomentsLogic()
    ...
    nonisolated func parseResponse(
        ...
        Task.detached { @Sendable in
            do {
                ...
                var dataDict: GenerateMomentsData? = nil
                if let dataObj = jsonObject["data"] as? [String: Any] {
                    ...
                    dataDict = GenerateMomentsData(
                        ...
                        total_count: dataObj["total_count"] as? Int ?? 0
                    )
                }
                
                let decodedResponse = GenerateMomentsResponse(
                    success: success,
                    message: message,
                    data: dataDict,
                    error: error
